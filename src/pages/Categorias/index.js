...
import { Container, Header,ContainerModal,Cont,Logos } from './styles';
  ...
  return (
    <>
      <Container>
        ...
        <Modals classe="" tipo="right" open={modalVisible} close={handleClose}>     
          <>
        ...
        <Modals classe="drawer" tipo="bottom" open={modalVisiblePlus} close={handleCloseModalPlus} >
          <Cont>
      ...
      <Logos>
        <a  href="https://gestorfood.com/" target="_blank">
         <img src={logo} alt="logo Gestor Food"/>
        </a>
      </Logos>
    </>
  );
